...
function TimelineEntry({
  ...
  return (
    <div className={`relative flex items-start gap-0 ${isLeft ? 'flex-row' : 'flex-row-reverse'} mb-16 last:mb-0`}>
      {/* Content card */}
      <motion.div
      ...
      >
        <div className="glass border border-white/5 rounded-2xl p-6 hover:border-indigo-500/20 transition-colors group">
          {/* Header */}
          <div className="flex items-start justify-between mb-3">
            ...
            {experience.is_current && (
              <span className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-xs font-medium text-green-400">
