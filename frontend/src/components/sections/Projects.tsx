...
const CATEGORY_GRADIENTS: Record<Project['category'], string> = {
  web: 'from-indigo-900 via-purple-900 to-gray-900',
  mobile: 'from-emerald-900 via-teal-900 to-gray-900',
  design: 'from-pink-900 via-rose-900 to-gray-900',
  other: 'from-orange-900 via-amber-900 to-gray-900',
};

const INDEX_GRADIENTS = [
  'from-indigo-900 via-purple-900 to-gray-900',
  'from-cyan-900 via-blue-900 to-gray-900',
  'from-emerald-900 via-teal-900 to-gray-900',
  'from-pink-900 via-rose-900 to-gray-900',
  'from-orange-900 via-amber-900 to-gray-900',
  'from-violet-900 via-purple-900 to-gray-900',
];

function getGradient(category: Project['category'], index: number): string {
  return CATEGORY_GRADIENTS[category] ?? INDEX_GRADIENTS[index % INDEX_GRADIENTS.length];
}
            ...
            >
              <AnimatePresence mode="popLayout">
                {displayed.map((project, i) => (
                  ...
                  >
                    {/* Card image / gradient */}
                    <div className={`relative h-40 sm:h-48 bg-gradient-to-br ${getGradient(project.category, i)} overflow-hidden`}>
